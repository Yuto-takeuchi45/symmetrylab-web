...
SymmetryLabは全員が大手外資コンサル出身です。志望先とこれまでの経験に合わせて丁寧なケース面接対策を行い、高い内定率を強みにコンサル転職を支援しています。ケース面接の準備や転職の進め方に迷っている方は、コンサル転職ならSymmetryLabへご相談ください。""",
    },
    {
        ...
        "title": "PwCコンサルの標準年収639万円、PwCアドバイザリーの公認会計士採用724万円──給与比較で見落とす職種の違い",
        "category": "転職・年収",
        "published_at": "2026-08-20T09:00:00",
        "excerpt": "PwCコンサルティングの学士標準年収639万円と、PwCアドバイザリーの公認会計士採用724万円を比較。賞与・資格・職種の違いを整理し、転職候補者が確認すべき条件を解説します。",
        "cover_image_url": "/images/blog-pwc-salary-comparison-20260820.jpg",
        "meta_title": "PwCコンサルの年収比較｜639万円と724万円の違い | SYMMETRY Lab",
        "meta_description": "PwCコンサルティングとPwCアドバイザリーの公式募集要項をもとに、標準年収・賞与・資格・職種の違いと転職判断のポイントを解説します。",
        "content": """PwCの採用情報を見ていると、「学士6,390,840円」と「標準年収724万円」という数字が目に入ります。単純に比べると、後者のほうが約85万円高い計算です。
...
## PwCコンサルティングの639万円は「賞与を含まない標準年収」
...
出典：[PwCコンサルティング 新卒採用募集要項](https://www.pwc.com/jp/ja/careers/consulting/campus/guideline.html)

## PwCアドバイザリーの724万円は公認会計士向けの条件
...
出典：[PwCアドバイザリー 公認会計士試験合格者採用案内](https://www.pwc.com/jp/ja/careers/advisory/cpa/assets/pdf/cpa-01.pdf)

## 約85万円の差を、そのまま待遇差と考えない
...
画像： [Pexels「Businessman Working with Documents and Using Laptop in an Office」](https://www.pexels.com/photo/businessman-working-with-documents-and-using-laptop-in-an-office-10376233/) ／ RDNE Stock project ／ Pexels License（無料利用条件を確認済み）
